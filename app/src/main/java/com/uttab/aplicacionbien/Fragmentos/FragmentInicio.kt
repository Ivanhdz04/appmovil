...
import com.uttab.aplicacionbien.Adaptadores.AdaptadorAnuncio
import com.uttab.aplicacionbien.Adaptadores.AdaptadorCategoria
...
import com.uttab.aplicacionbien.databinding.FragmentInicioBinding
...
class FragmentInicio : Fragment() {
    ...
    private companion object{
        private const val MAX_DISTANCIA_MOSTRAR_ANUNCIO = 10000
    }
    ...
    private fun cargarCategorias(){
        ...
        binding.IbLimpiar.setOnClickListener {
            ...
            if (consulta.isNotEmpty()){
                ...
                Toast.makeText(context, "se ha limpiado el campo de la busqueda", Toast.LENGTH_SHORT).show()
            }else{
